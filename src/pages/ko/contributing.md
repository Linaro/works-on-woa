...
<!-- <a class="border-white border-2 px-4 py-2 rounded-xl hover:bg-white hover:text-black no-underline" href="/ko/contributing/applications">앱 요청 양식</a> -->
<a class="border-white border-2 px-4 py-2 rounded-xl hover:bg-white hover:text-black no-underline" href="#">아직 작업 중입니다!</a>
...
<!-- <a class="border-white border-2 px-4 py-2 rounded-xl hover:bg-white hover:text-black no-underline" href="/ko/contributing/games">게임 요청 양식</a> -->
<a class="border-white border-2 px-4 py-2 rounded-xl hover:bg-white hover:text-black no-underline" href="#">아직 작업 중입니다!</a>
